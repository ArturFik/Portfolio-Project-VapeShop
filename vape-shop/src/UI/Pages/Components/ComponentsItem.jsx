...
import Charon from './ComponentsPhoto/ComponentsCharon+.png'

const ComponentsItem = (props) =>{
    return(
            <div id="catalog-box" className="catalog-box">
                <div className="catalog-Photo back">
                    <img className="catalog-Photo-Components" src={Charon} alt="catalog-podPhoto"/>
                </div>    
